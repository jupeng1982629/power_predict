...
create table ods_power_realtime (
  ...
  apparent_power_kva  double comment '视在功率（kVA）',
  power_factor_total  double comment '总功率因数',
  power_factor_a      double comment 'A 相功率因数',
  power_factor_b      double comment 'B 相功率因数',
  power_factor_c      double comment 'C 相功率因数',
  voltage_phase_a     double comment 'A 相电压（V）',
  voltage_phase_b     double comment 'B 相电压（V）',
  voltage_phase_c     double comment 'C 相电压（V）',
  current_phase_a     double comment 'A 相电流（A）',
  current_phase_b     double comment 'B 相电流（A）',
  current_phase_c     double comment 'C 相电流（A）',
  frequency_hz        double comment '电网频率（Hz）',
  energy_15m_kwh      double comment '15 分钟时段发电量（kWh）',
  energy_daily_kwh    double comment '当日累计发电量（kWh）',
...
create table dwd_power_15m (
  ...
  reactive_power_kvar double comment '清洗后无功功率（kVar）',
  power_factor_total  double comment '清洗后总功率因数',
  voltage_phase_a     double comment 'A 相电压（V）',
  voltage_phase_b     double comment 'B 相电压（V）',
  voltage_phase_c     double comment 'C 相电压（V）',
  current_phase_a     double comment 'A 相电流（A）',
  current_phase_b     double comment 'B 相电流（A）',
  current_phase_c     double comment 'C 相电流（A）',
  energy_15m_kwh      double comment '15 分钟发电量（kWh）',
  energy_daily_kwh    double comment '当日累计发电量（kWh）',
